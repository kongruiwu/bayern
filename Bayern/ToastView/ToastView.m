...
+ (ToastView *)presentWhiteToastWithin:(UIView *)superview withIcon:(APToastIcon)icon text:(NSString *)text duration:(NSTimeInterval)duration
{
    return [self presentWhiteToastWithin:superview
                                withIcon:icon
                                    text:text
                                duration:duration
                              completion:NULL];
}
+ (ToastView *)presentWhiteToastWithin:(UIView *)superview withIcon:(APToastIcon)icon text:(NSString *)text duration:(NSTimeInterval)duration completion:(void (^)())completion
{
...
+ (ToastView *)presentWhiteToastWithin:(UIView *)superview
...
{
    ToastView *toast = [[ToastView alloc] initWithWhiteText:text toastType:icon];
...
- (id)initWithWhiteText:(NSString *)text toastType:(APToastIcon)icon
{
    self = [super init];
    if (self) {
        _iconType = icon;
        ...
        // 添加背景图片
        UIImage *bgImage = _iconView ? APCommonUILoadImage(@"toast_icon_white") : APCommonUILoadImage(@"toast_white");
